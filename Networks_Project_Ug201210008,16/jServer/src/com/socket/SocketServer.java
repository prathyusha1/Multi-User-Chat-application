...
public class SocketServer implements Runnable {
            ...
            if(msg.type.equals("login")){
                if(findUserThread(msg.sender) == null){
                    if(db.checkLogin(msg.sender, msg.content)){
                        ...
                        ui.jTextArea1.append("\n ->"+clients[findClient(ID)].username+" logged in");
                    }
                    else{
                ...
                if(findUserThread(msg.sender) == null){
                    if(!db.userExists(msg.sender)){
                        ...
                        clients[findClient(ID)].send(new Message("login", "SERVER", "TRUE", msg.sender));
                        Announce("newuser", "SERVER", msg.sender);
                         ui.jTextArea1.append("\n->"+clients[findClient(ID)].username+" signed up");
    ...
    int pos = findClient(ID);
	    ...
	    ui.jTextArea1.append("\n ->"+clients[findClient(ID)].username+"has logged out");
	...
	if (clientCount < clients.length){  
           // ui.jTextArea1.append("\n"+clients[findClient(clientCount)].username+"logged in");
